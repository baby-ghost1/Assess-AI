          ...
          <div className="relative rounded-2xl p-[1px] overflow-hidden">
            ...
            <div className="relative rounded-2xl bg-bg-card/95 backdrop-blur-xl p-8">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="flex items-center justify-center gap-2 rounded-xl border border-border bg-bg-secondary py-2.5 text-sm font-medium text-text-primary hover:bg-bg-tertiary hover:border-border-light hover:scale-[1.02] hover:shadow-lg hover:shadow-primary/5 transition-all duration-200"
                >
