...
import { X, Music, Trash2, Play, Clock } from 'lucide-react'
    ...
    >
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <button
          ...
          className="text-[#7f7f7f] hover:text-white opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-all p-1"
        >
...
export default function QueuePanel() {
  const {
    currentTrack, isPlaying, queue, queueIndex, upcomingTracks,
    ...
    <AnimatePresence>
      {queuePanelOpen && (
        <motion.div
           ...
           className="fixed bottom-[72px] right-0 z-[59] h-[min(70vh,420px)] w-full overflow-hidden bg-[#121212] border-l border-[#282828] shadow-2xl shadow-black/50 sm:w-[320px]"
        >
           <div className="h-full flex flex-col w-full sm:w-[320px]">
            {/* Header */}
              ...
              {currentTrack && (
                <div className="mb-4">
                  ...
                  <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-[#282828]/50">
                    <div className="relative h-12 w-12 shrink-0 rounded-full shadow-lg">
                      <div className="absolute inset-0 rounded-full bg-gradient-to-br from-[#2a2a2a] via-[#1a1a1a] to-[#111]" />
                      <div className="absolute inset-[2px] rounded-full overflow-hidden bg-[#282828]">
                        {currentTrack.image ? (
                      ...
                      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-1.5 w-1.5 rounded-full bg-[#181818] border border-[#333] z-10" />
                    </div>
